...
//最小设定弹速
#define MIN_SET_BULLET_SPEED 2.0f
//最大设定弹速
...
// 击打敌方机器人0.1
//imu到枪口的竖直距离
#define Z_STATIC (0.0594f)
//枪口前推距离
#define DISTANCE_STATIC (0.0975f)
//初始飞行时间
...
typedef enum
{
    TARGET_FOLLOW, // 未识别到目标
    TARGET_NO_FOLLOW,   // 识别到目标
} vision_target_follow_state_e;
...
typedef struct
{
    ...
    //机器人状态指针
    const ext_robot_state_t* robot_state_point;
    //发射机构弹速指针
    ...
    // 云台跟随状态
    vision_target_follow_state_e vision_target_follow_state;
    // 目标装甲板编号
