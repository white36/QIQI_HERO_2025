...
#define PITCH_REMOTE_FIRE_PID_KP 95.0f
#define PITCH_REMOTE_FIRE_PID_KI 1.0f
#define PITCH_REMOTE_FIRE_PID_KD 4.0f
#define PITCH_REMOTE_FIRE_PID_MAX_OUT 16000.0f
#define PITCH_REMOTE_FIRE_PID_MAX_IOUT 1000.0f

typedef enum
{
    GIMBAL_MOTOR_RAW = 0,     // 电机原始值控制 现在仅作为无力使用
    GIMBAL_MOTOR_GYRO,        // 电机陀螺仪角度控制
    GIMBAL_MOTOR_REMOTE_FIRE, // 电机吊射控制
    GIMBAL_MOTOR_ENCONDE,     // 电机编码值角度控制
    GIMBAL_MOTOR_GYRONOLIMIT, // 小陀螺陀螺仪控制
    GIMBAL_MOTOR_AUTO,
    GIMBAL_MOTOR_TURN_ROUND, // 回头模式绝对角控制
} gimbal_motor_mode_e;
...
typedef struct
{
    ...
    PID_t yaw_pos_pid; // 带有变速积分的pid,用于自瞄
    PID_t yaw_speed_pid;
    pid_type_def pitch_remote_fire_pid; // 吊射pitch轴pid
    ...
    fp32 gimbal_back_init_angle; // 一键掉头初始角度
    ...
    TickType_t tmp_start_time;
    TickType_t tmp_remain_time;
    TickType_t start_remote_shoot_time; // 用于调整吊射时pitch限位
} gimbal_control_t;
