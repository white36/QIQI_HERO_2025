...
extern DW_stm32 stm32_DW_auto_yaw;
extern DW_stm32 stm32_DW_auto_pitch;
extern DW_stm32 stm32_DW_trigger;

/* External inputs (root inport signals with default storage) */
extern ExtU_stm32 stm32_U_yaw;
extern ExtU_stm32 stm32_U_pitch;
extern ExtU_stm32 stm32_U_auto_yaw;
extern ExtU_stm32 stm32_U_auto_pitch;
extern ExtU_stm32 stm32_U_trigger;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_stm32 stm32_Y_yaw;
extern ExtY_stm32 stm32_Y_pitch;
extern ExtY_stm32 stm32_Y_auto_yaw;
extern ExtY_stm32 stm32_Y_auto_pitch;
...
extern void stm32_pid_auto_yaw_init(void);
extern void stm32_pid_auto_pitch_init(void);
...
extern void stm32_step_auto_pitch(double angle_set, double angle_feedback, double speed_feedback);
extern void stm32_step_auto_yaw(double angle_set, double angle_feedback, double speed_feedback);
extern void stm32_step_trigger(double angle_set,double angle_feedback,double speed_feedback);

// clear pid
extern void stm32_pid_clear_yaw(void);
extern void stm32_pid_clear_pitch(void);
extern void stm32_pid_clear_auto_yaw(void);
extern void stm32_pid_clear_auto_pitch(void);
